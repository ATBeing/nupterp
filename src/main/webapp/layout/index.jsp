...
<body class="easyui-layout">
	...
	<!-- 北部面板  -->
	<div data-options="border:false,region:'north',href:'../layout/north.jsp'" style="height: 60px;overflow: hidden;"
		class="logo"></div>
	...
	<!-- 中部面板 -->
	<div data-options="region:'center',border:false,title:'欢迎使用ERP管理系统'" style="overflow: hidden;">
